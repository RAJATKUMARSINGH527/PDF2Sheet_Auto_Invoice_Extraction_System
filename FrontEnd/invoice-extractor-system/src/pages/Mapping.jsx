...
export default function Mapping() {
  ...
  // --- LOGIC ---
  // Logic section mein check karo
  const safePath = invoice.filePath ? invoice.filePath.replace(/\\/g, "/") : "";
  // Agar backend direct link bhejta hai toh as-is, varna baseUrl add karo
  const fileUrl = safePath.startsWith("http")
    ? safePath
    : `${API_BASE_URL}/${safePath}`;
